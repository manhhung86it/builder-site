 ...
 *
 * Override this template by copying it to yourtheme/portfolio/expander/social-icons.php
 *
 * @author 		A3 Rev
 * @version     1.0.0
 */
...
$postimage         = a3_portfolio_get_first_thumb_image_url( $portfolio_id, $portfolio_gallery, false );
...
<div class="social-actions-single">
	...
	<span class="social-action social-action-facebook">
		...
		<a onclick="window.open(this.href, 'popupwindow', 'width=655,height=380,scrollbars,resizable'); return false;"
			...
			href="http://www.facebook.com/sharer.php?m2w&s=100&p[url]=<?php echo urlencode( $postlink ); ?>&p[images][0]=<?php echo urlencode( $postimage ); ?>&p[title]=<?php echo get_the_title( $portfolio_id ); ?>&p[summary]=<?php echo $desc; ?>"><?php echo a3_portfolio_ei_ict_t__( 'Social - Facebook', __( 'Facebook', 'a3_portfolios' ) ); ?></a>
	...
	<span class="social-action social-action-gplus">
		...
		<a onclick="javascript:window.open(this.href, '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;"
			href="https://plus.google.com/share?url='.$postlink.'" ><?php echo a3_portfolio_ei_ict_t__( 'Social - Google Plus', __( 'Google+', 'a3_portfolios' ) ); ?></a>
