...
class A3_Portfolio_Category_Taxonomy
{
	...
	public function plugin_init() {
		...
		add_action( 'portfolio_cat_edit_form_fields', array( $this, 'a3_portfolio_taxonomy_edit_meta_field' ), 11, 2 );
    ...
    public function portfolio_term_ordering_validate_script() {
		...
		wp_register_script( 'a3-portfolio-term-validate-admin-script', A3_PORTFOLIO_JS_URL . '/a3.portfolio.term.validate.admin' . $suffix . '.js', array('jquery'), '1.0.0' );
	...
	public function a3_portfolio_taxonomy_add_new_meta_field() {
		...
		<h3><?php _e( 'Portfolio Nav Bar Item', 'a3_portfolios' ); ?></h3>
